...
-- Dumping database structure for wamdha
CREATE DATABASE IF NOT EXISTS `wamdha` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `wamdha`;
...
INSERT INTO `company_settings` (`id`, `company_name`, `company_name_ar`, `company_logo`, `hero_title`, `hero_title_ar`, `hero_subtitle`, `hero_subtitle_ar`) VALUES
	(1, 'wamdha', 'ومضة', 'logo_1762617228.png', 'From the spark of the idea.. to the reality of achievement.', 'من شرارة الفكرة.. إلى واقع الإنجاز.', 'At Wamdha, we believe that every great project starts with a spark of inspiration. We are a tech company specializing in transforming these bright ideas into powerful software solutions and tangible realities. Our motto combines innovation and precision; we not only provide creative solutions but also ensure their implementation to the highest standards of quality and reliability. Our mission is to be your technology partner, building together your digital gateway to the future.', 'في ومضة، نؤمن بأن كل مشروع عظيم يبدأ بومضة إلهام. نحن شركة تقنية متخصصة في تحويل هذه الأفكار اللامعة إلى حلول برمجية قوية وواقع ملموس. ​شعارنا يجمع بين الابتكار والدقة؛ فنحن لا نكتفي بتقديم حلول إبداعية فحسب، بل نضمن تنفيذها بأعلى معايير الجودة والموثوقية. مهمتنا هي أن نكون شريكك التقني، لنبني معًا بوابتك الرقمية نحو المستقبل.');
...
-- Dumping structure for table wamdha.news
...
-- Dumping data for table wamdha.news: ~4 rows (approximately)
INSERT INTO `news` (`id`, `title_en`, `title_ar`, `details_en`, `details_ar`, `image`, `publication_date`, `link`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'Our New Platform "Nova" Has Launched', 'أطلقنا مشروعنا الجديد "نوفا"', 'Full details about the Nova platform...', 'تفاصيل كاملة حول منصة نوفا...', 'news-1.jpg', '2025-10-28', NULL, 'published', '2025-11-12 21:11:17', '2025-11-12 21:11:17'),
	(2, 'We Won the Best Work Environment Award', 'فزنا بجائزة أفضل بيئة عمل', 'Details about the award and what it means for our team...', 'تفاصيل حول الجائزة وما تعنيه لفريقنا...', 'news-2.jpg', '2025-10-15', NULL, 'published', '2025-11-12 21:11:17', '2025-11-12 21:11:17'),
	(3, 'New Article: The Future of Artificial Intelligence', 'مقال جديد: مستقبل الذكاء الاصطناعي', 'An in-depth look at the future of AI...', 'نظرة متعمقة على مستقبل الذكاء الاصطناعي...', 'news-3.jpg', '2025-10-05', NULL, 'published', '2025-11-12 21:11:17', '2025-11-12 21:11:17'),
	(4, 'Upcoming Webinar on Digital Marketing', 'ندوة قادمة عن التسويق الرقمي', 'Join our free webinar next month...', 'انضموا إلى ندوتنا المجانية الشهر القادم...', 'news-1762982125.png', '2025-11-20', '', 'draft', '2025-11-12 21:11:17', '2025-11-12 21:15:25');
...
-- Dumping data for table wamdha.products: ~6 rows (approximately)
INSERT INTO `products` (`id`, `name`, `name_ar`, `image`, `details_url`, `description`, `description_ar`) VALUES
	...
	(18, 'tariq mohammed', 'ومضة', 'product_1762967499.jpg', '', 'sksal', '');
...
-- Dumping data for table wamdha.product_category_map: ~8 rows (approximately)
